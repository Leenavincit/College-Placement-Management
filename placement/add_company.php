...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO companies 
              (name, industry, location, email, phone, password) 
              VALUES 
              ('$name','$industry','$location','$email','$phone','$password')";
    ...
    if($result){
        echo "<script>alert('Company Added Successfully!'); window.location='view_company.php';</script>";
    } else {
...
<div class="page-content">
    <div class="form-card">
        ...
        <form method="POST">
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <input type="text" name="name"
                           placeholder="e.g. TechSpark Pvt Ltd" required>
                </div>

                <div class="form-group">
                    <label>Industry</label>
                    <input type="text" name="industry"
                           placeholder="e.g. Software" required>
                </div>
            ...
            <div class="note">
                ℹ️ Default login password will be set to <strong>123</strong>.
                Company can change it after login.
            </div>
